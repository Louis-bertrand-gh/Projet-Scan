 ...
 * plusieurs sites, points de vente, catégories et produits.
 * En production, ces données proviendront d'une API/BDD.
 * ═══════════════════════════════════════════════════════════════════════ */
...
/* ─── Points de Vente ────────────────────────────────────────────────── */
export const pointsDeVente: PointDeVente[] = [
  {
    id: "pdv-1",
    nom: "Pizzeria",
    siteId: "site-1",
    icone: "Pizza",
    categorieIds: ["cat-1", "cat-3", "cat-4", "cat-5"],
  },
  {
    id: "pdv-2",
    nom: "Bar",
  ...
  },
  {
    ...
    siteId: "site-2",
    icone: "Sandwich",
    categorieIds: ["cat-2", "cat-5", "cat-6"],
  },
  {
    id: "pdv-6",
    nom: "Brasserie",
...
export const produits: Produit[] = [
  // Fromages
  {
    ...
    nom: "Bûche de Chèvre",
    categorieId: "cat-1",
    pointDeVenteIds: ["pdv-1", "pdv-3", "pdv-4", "pdv-6"],
    unite: "pièce",
    seuilReassort: 5,
    stockActuel: 3,
  ...
  },
  {
    ...
    categorieId: "cat-1",
    pointDeVenteIds: ["pdv-1", "pdv-3", "pdv-4"],
    unite: "kg",
    seuilReassort: 2,
    stockActuel: 4,
  ...
  },
  {
    ...
    nom: "Comté 18 mois",
    categorieId: "cat-1",
    pointDeVenteIds: ["pdv-3", "pdv-6", "pdv-7"],
    unite: "kg",
    seuilReassort: 1,
    stockActuel: 0.5,
  ...
  // Boissons
  {
    ...
    categorieId: "cat-2",
    pointDeVenteIds: ["pdv-2", "pdv-3", "pdv-5", "pdv-7"],
    unite: "L",
    seuilReassort: 10,
    stockActuel: 6,
  ...
  },
  {
    ...
    categorieId: "cat-2",
    pointDeVenteIds: ["pdv-2", "pdv-5", "pdv-6"],
    unite: "L",
    seuilReassort: 15,
    stockActuel: 20,
  ...
  },
  {
    ...
    categorieId: "cat-2",
    pointDeVenteIds: ["pdv-2", "pdv-3", "pdv-4", "pdv-5", "pdv-6", "pdv-7"],
    unite: "pièce",
    seuilReassort: 30,
    stockActuel: 45,
  ...
  },
  {
    ...
    nom: "Salade Batavia",
    categorieId: "cat-4",
    pointDeVenteIds: ["pdv-3", "pdv-4", "pdv-6", "pdv-7"],
    unite: "pièce",
    seuilReassort: 10,
    stockActuel: 4,
  ...
  },
  {
    ...
    categorieId: "cat-5",
    pointDeVenteIds: ["pdv-1", "pdv-3", "pdv-5"],
    unite: "L",
    seuilReassort: 3,
    stockActuel: 1,
  ...
  // Desserts
  {
    ...
    categorieId: "cat-6",
    pointDeVenteIds: ["pdv-2", "pdv-5", "pdv-7"],
    unite: "bac",
    seuilReassort: 3,
    stockActuel: 2,
...
/* ─── Historique de scans simulé ─────────────────────────────────────── */
export const historiqueScans: ScanHACCP[] = [
  {
    id: "scan-1",
    produitId: "prod-1",
    pointDeVenteId: "pdv-1",
    userId: "user-1",
    dateScan: "2026-03-12T08:30:00",
  ...
  },
  {
    id: "scan-2",
    produitId: "prod-8",
    pointDeVenteId: "pdv-3",
    userId: "user-1",
    dateScan: "2026-03-11T14:15:00",
